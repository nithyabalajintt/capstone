...
#loading configuration as dictionary
import yaml
 
# Load YAML as a dictionary
with open("config.yml", "r") as file:
    config = yaml.safe_load(file)  # Always returns a dictionary
 
# Print to confirm it's a dictionary
print(type(config))  # Should print <class 'dict'>
print(config.get("colang_version"))  # Should print "1.0"
 
# Pass the dictionary to LLMRails
